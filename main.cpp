...
int main()
{
    ...
    while(choose != EXIT) {
        switch(choose) {
            ...
            case CANCEL_JOIN_EVENT:system("cls"); {
            ...
            case SHOW_AVAILABLE_EVENTS:system("cls"); {
                showEvents(eventList, SHOW_ONLY_AVAILABLE);
                break;
            }
            case SHOW_EVENTS_WITH_PARTICIPANT:system("cls"); {
                showEvents(eventList, SHOW_ALL, true, true);
                break;
            }
            case SHOW_PARTICIPANTS_IN_AN_EVENT:system("cls"); {
                string eventName;
                adr_event searchCurrentEvent;
            ...
            case SEARCH_PARTICIPANT_IN_AN_EVENT:system("cls"); {
                string eventName, participantEmail;
                adr_event searchCurrentEvent;
            ...
            case REGISTER_PARTICIPANT:system("cls"); {
            ...
            case REMOVE_PARTICIPANT:system("cls"); {
            ...
            case SHOW_PARTICIPANTS:system("cls"); {
                showParticipants(participantsList);
                break;
            }
            case SHOW_EVENTS:system("cls"); {
                showEvents(eventList, SHOW_ALL, true, false);
                break;
            }

        }
        if(choose == 5 || choose == 6 || choose == 7 || choose == 11 || choose == 12){
            showMenu();
        }else{
            system("cls");
            showMenu();
